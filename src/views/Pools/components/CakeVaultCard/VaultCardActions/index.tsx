...
import { Flex, Text, Box } from '@fox/uikit';
...
const CakeVaultCardActions: React.FC<{
  ...
  const stakingTokenBalance = userInfo.stakingTokenBalance ? new BigNumber(userInfo.stakingTokenBalance) : BIG_ZERO;
  ...
  useEffect(() => {
    ...
    checkApprovalStatus();
  }, [account, cakeVaultContract, lastUpdated, cakeContract]);
