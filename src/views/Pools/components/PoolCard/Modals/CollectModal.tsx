...
const CollectModal: React.FC<CollectModalProps> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Text mb='12px'>{t('Compound: collect and restake FOX into pool.')}</Text>
      <Text>{t('Harvest: collect FOX and send to wallet')}</Text>
    </>,
    ...
    <Modal
      ...
      <Flex
        ...
        <Flex flexDirection='column'>
          ...
          <Text
            fontSize='12px'
            color='textSubtle'>{`~${earningsDollarValue || 0} USD`}
          </Text>
        </Flex>
      </Flex>
      ...
      <Button
        ...
        isLoading={pendingTx}
        endIcon={pendingTx ? <AutoRenewIcon
          spin
